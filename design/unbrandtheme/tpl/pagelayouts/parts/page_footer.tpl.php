<?php if(isset($_SESSION[lhc_ezcAuth_id])) echo "<a class=\"btn btn-warning\" href = \"../../../wapp-LHC-Bridge/lhc-extensions-bookmarks/output/bookmarks_list.php?user=$_SESSION[lhc_ezcAuth_id]\" target=_blank> Abrir Contatos </a>"; ?>
<?php if(isset($_SESSION[lhc_ezcAuth_id])) echo "<a class=\"btn btn-success\" href = \"../../../wapp-LHC-Bridge/lhc-extensions-bookmarks/output/bookmarks_inits_add.php?user=$_SESSION[lhc_ezcAuth_id]\" target=_blank> Iniciar contato </a>"; ?>
